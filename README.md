...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [NewRepository](#newrepository) [NewRepositoryWithTTL](#newrepositorywithttl) [NewStore](#newstore) |
| **Memoization** | [NewMemoStore](#newmemostore) |
| **Repository** | [Add](#add) [Decrement](#decrement) [Delete](#delete) [DeleteMany](#deletemany) [Flush](#flush) [Get](#get) [GetString](#getstring) [Increment](#increment) [Pull](#pull) [Remember](#remember) [RememberString](#rememberstring) [Set](#set) [SetString](#setstring) [Store](#store) |
| **Repository JSON** | [GetJSON](#getjson) [RememberJSON](#rememberjson) [SetJSON](#setjson) |


## Constructors

### <a id="newrepository"></a>NewRepository
...
### <a id="newrepositorywithttl"></a>NewRepositoryWithTTL
