...
| **Core** | [Cache.Driver](#cache-driver) [Cache.Store](#cache-store) [NewCache](#newcache) [NewCacheWithTTL](#newcachewithttl) |
| **Invalidation** | [Cache.Delete](#cache-delete) [Cache.DeleteCtx](#cache-deletectx) [Cache.DeleteMany](#cache-deletemany) [Cache.DeleteManyCtx](#cache-deletemanyctx) [Cache.Flush](#cache-flush) [Cache.FlushCtx](#cache-flushctx) [Cache.PullBytes](#cache-pullbytes) [Cache.PullBytesCtx](#cache-pullbytesctx) [Pull](#pull) [PullCtx](#pullctx) |
| **Locking** | [Cache.Lock](#cache-lock) [Cache.LockCtx](#cache-lockctx) [Cache.NewLockHandle](#cache-newlockhandle) [Cache.TryLock](#cache-trylock) [Cache.TryLockCtx](#cache-trylockctx) [Cache.Unlock](#cache-unlock) [Cache.UnlockCtx](#cache-unlockctx) [LockHandle.Acquire](#lockhandle-acquire) [LockHandle.AcquireCtx](#lockhandle-acquirectx) [LockHandle.Block](#lockhandle-block) [LockHandle.BlockCtx](#lockhandle-blockctx) [LockHandle.Get](#lockhandle-get) [LockHandle.GetCtx](#lockhandle-getctx) [LockHandle.Release](#lockhandle-release) [LockHandle.ReleaseCtx](#lockhandle-releasectx) |
| **Memoization** | [NewMemoStore](#newmemostore) |
| **Observability** | [Cache.WithObserver](#cache-withobserver) |
...
| **Rate Limiting** | [Cache.RateLimit](#cache-ratelimit) [Cache.RateLimitCtx](#cache-ratelimitctx) |
| **Read Through** | [Cache.RememberBytes](#cache-rememberbytes) [Cache.RememberBytesCtx](#cache-rememberbytesctx) [Cache.RememberStaleBytes](#cache-rememberstalebytes) [Cache.RememberStaleBytesCtx](#cache-rememberstalebytesctx) [Cache.RememberString](#cache-rememberstring) [Cache.RememberStringCtx](#cache-rememberstringctx) [Remember](#remember) [RememberJSON](#rememberjson) [RememberJSONCtx](#rememberjsonctx) [RememberStale](#rememberstale) [RememberStaleCtx](#rememberstalectx) [RememberStaleValueWithCodec](#rememberstalevaluewithcodec) [RememberValue](#remembervalue) [RememberValueWithCodec](#remembervaluewithcodec) |
| **Reads** | [Cache.BatchGetBytes](#cache-batchgetbytes) [Cache.BatchGetBytesCtx](#cache-batchgetbytesctx) [Cache.GetBytes](#cache-getbytes) [Cache.GetBytesCtx](#cache-getbytesctx) [Cache.GetString](#cache-getstring) [Cache.GetStringCtx](#cache-getstringctx) [Get](#get) [GetCtx](#getctx) [GetJSON](#getjson) [GetJSONCtx](#getjsonctx) |
| **Refresh Ahead** | [Cache.RefreshAheadBytes](#cache-refreshaheadbytes) [Cache.RefreshAheadBytesCtx](#cache-refreshaheadbytesctx) [RefreshAhead](#refreshahead) [RefreshAheadCtx](#refreshaheadctx) [RefreshAheadValueWithCodec](#refreshaheadvaluewithcodec) |
| **Writes** | [Cache.Add](#cache-add) [Cache.AddCtx](#cache-addctx) [Cache.BatchSetBytes](#cache-batchsetbytes) [Cache.BatchSetBytesCtx](#cache-batchsetbytesctx) [Cache.Decrement](#cache-decrement) [Cache.DecrementCtx](#cache-decrementctx) [Cache.Increment](#cache-increment) [Cache.IncrementCtx](#cache-incrementctx) [Cache.SetBytes](#cache-setbytes) [Cache.SetBytesCtx](#cache-setbytesctx) [Cache.SetString](#cache-setstring) [Cache.SetStringCtx](#cache-setstringctx) [Set](#set) [SetCtx](#setctx) [SetJSON](#setjson) [SetJSONCtx](#setjsonctx) |
...
### <a id="cache-driver"></a>Cache.Driver

Driver reports the underlying store driver.

### <a id="cache-store"></a>Cache.Store
...
### <a id="cache-delete"></a>Cache.Delete
...
### <a id="cache-deletectx"></a>Cache.DeleteCtx

DeleteCtx is the context-aware variant of Delete.

### <a id="cache-deletemany"></a>Cache.DeleteMany
...
### <a id="cache-deletemanyctx"></a>Cache.DeleteManyCtx

DeleteManyCtx is the context-aware variant of DeleteMany.

### <a id="cache-flush"></a>Cache.Flush
...
### <a id="cache-flushctx"></a>Cache.FlushCtx

FlushCtx is the context-aware variant of Flush.

### <a id="cache-pullbytes"></a>Cache.PullBytes
...
### <a id="cache-pullbytesctx"></a>Cache.PullBytesCtx
...
### <a id="cache-lockctx"></a>Cache.LockCtx

LockCtx retries lock acquisition until success or context cancellation.

### <a id="cache-newlockhandle"></a>Cache.NewLockHandle
...
### <a id="cache-trylock"></a>Cache.TryLock
...
### <a id="cache-trylockctx"></a>Cache.TryLockCtx

TryLockCtx is the context-aware variant of TryLock.

### <a id="cache-unlock"></a>Cache.Unlock
...
### <a id="cache-unlockctx"></a>Cache.UnlockCtx

UnlockCtx is the context-aware variant of Unlock.

### <a id="lockhandle-acquire"></a>LockHandle.Acquire
...
### <a id="lockhandle-acquirectx"></a>LockHandle.AcquireCtx

AcquireCtx is the context-aware variant of Acquire.

### <a id="lockhandle-block"></a>LockHandle.Block
...
### <a id="lockhandle-blockctx"></a>LockHandle.BlockCtx
...
### <a id="lockhandle-release"></a>LockHandle.Release
...
### <a id="lockhandle-releasectx"></a>LockHandle.ReleaseCtx
...
### <a id="cache-withobserver"></a>Cache.WithObserver
...
### <a id="cache-ratelimit"></a>Cache.RateLimit
...
### <a id="cache-ratelimitctx"></a>Cache.RateLimitCtx

RateLimitCtx is the context-aware variant of RateLimit.

## Read Through

### <a id="cache-rememberbytes"></a>Cache.RememberBytes
...
### <a id="cache-rememberbytesctx"></a>Cache.RememberBytesCtx

RememberBytesCtx is the context-aware variant of RememberBytes.

### <a id="cache-rememberstalebytes"></a>Cache.RememberStaleBytes
...
### <a id="cache-rememberstalebytesctx"></a>Cache.RememberStaleBytesCtx

RememberStaleBytesCtx is the context-aware variant of RememberStaleBytes.

### <a id="cache-rememberstring"></a>Cache.RememberString
...
### <a id="cache-rememberstringctx"></a>Cache.RememberStringCtx
...
### <a id="cache-batchgetbytes"></a>Cache.BatchGetBytes
...
### <a id="cache-batchgetbytesctx"></a>Cache.BatchGetBytesCtx

BatchGetBytesCtx is the context-aware variant of BatchGetBytes.

### <a id="cache-getbytes"></a>Cache.GetBytes
...
### <a id="cache-getbytesctx"></a>Cache.GetBytesCtx

GetBytesCtx is the context-aware variant of GetBytes.

### <a id="cache-getstring"></a>Cache.GetString
...
### <a id="cache-getstringctx"></a>Cache.GetStringCtx
...
### <a id="cache-refreshaheadbytes"></a>Cache.RefreshAheadBytes
...
### <a id="cache-refreshaheadbytesctx"></a>Cache.RefreshAheadBytesCtx
...
### <a id="cache-addctx"></a>Cache.AddCtx

AddCtx is the context-aware variant of Add.

### <a id="cache-batchsetbytes"></a>Cache.BatchSetBytes
...
### <a id="cache-batchsetbytesctx"></a>Cache.BatchSetBytesCtx

BatchSetBytesCtx is the context-aware variant of BatchSetBytes.

### <a id="cache-decrement"></a>Cache.Decrement
...
### <a id="cache-decrementctx"></a>Cache.DecrementCtx

DecrementCtx is the context-aware variant of Decrement.

### <a id="cache-increment"></a>Cache.Increment
...
### <a id="cache-incrementctx"></a>Cache.IncrementCtx

IncrementCtx is the context-aware variant of Increment.

### <a id="cache-setbytes"></a>Cache.SetBytes
...
### <a id="cache-setbytesctx"></a>Cache.SetBytesCtx

SetBytesCtx is the context-aware variant of SetBytes.

### <a id="cache-setstring"></a>Cache.SetString
...
### <a id="cache-setstringctx"></a>Cache.SetStringCtx
