...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/unit_tests-284-brightgreen" alt="Unit tests (executed count)">
...
| **Other** | [IntegrationWrapEncryptingStore](#integrationwrapencryptingstore) [IntegrationWrapShapingStore](#integrationwrapshapingstore) |
