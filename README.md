...
| Group | Functions |
|------:|:-----------|
| **Constructors** | [NewCache](#newrepository) [NewCacheWithTTL](#newrepositorywithttl) [NewStore](#newstore) |
...
### <a id="newrepository"></a>NewCache

NewCache creates a cache repository bound to a concrete store.
...
### <a id="newrepositorywithttl"></a>NewCacheWithTTL
