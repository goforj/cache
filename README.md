...
| **Invalidation** | [Delete (+Ctx)](#cache-delete) [DeleteMany (+Ctx)](#cache-deletemany) [Flush (+Ctx)](#cache-flush) [Pull (+Ctx)](#pull) [PullBytes (+Ctx)](#cache-pullbytes) |
| **Locking** | [Acquire (+Ctx)](#lockhandle-acquire) [Block (+Ctx)](#lockhandle-block) [Lock](#cache-lock) [LockCtx](#cache-lockctx) [LockHandle.Get (+Ctx)](#lockhandle-get) [NewLockHandle](#cache-newlockhandle) [Release (+Ctx)](#lockhandle-release) [TryLock (+Ctx)](#cache-trylock) [Unlock (+Ctx)](#cache-unlock) |
...
| **Rate Limiting** | [RateLimit (+Ctx)](#cache-ratelimit) |
| **Read Through** | [Remember (+Ctx)](#remember) [RememberBytes (+Ctx)](#cache-rememberbytes) [RememberStale](#rememberstale) [RememberStaleBytes (+Ctx)](#cache-rememberstalebytes) [RememberStaleCtx](#rememberstalectx) |
| **Reads** | [BatchGetBytes (+Ctx)](#cache-batchgetbytes) [Get (+Ctx)](#get) [GetBytes (+Ctx)](#cache-getbytes) [GetJSON (+Ctx)](#getjson) [GetString (+Ctx)](#cache-getstring) |
| **Refresh Ahead** | [RefreshAhead (+Ctx)](#refreshahead) [RefreshAheadBytes (+Ctx)](#cache-refreshaheadbytes) [RefreshAheadValueWithCodec](#refreshaheadvaluewithcodec) |
| **Writes** | [Add (+Ctx)](#cache-add) [BatchSetBytes (+Ctx)](#cache-batchsetbytes) [Decrement (+Ctx)](#cache-decrement) [Increment (+Ctx)](#cache-increment) [Set (+Ctx)](#set) [SetBytes (+Ctx)](#cache-setbytes) [SetJSON (+Ctx)](#setjson) [SetString (+Ctx)](#cache-setstring) |
