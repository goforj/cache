...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/unit_tests-283-brightgreen" alt="Unit tests (executed count)">
...
| **Other** | [IntegrationWrapEncryptingStore](#integrationwrapencryptingstore) [IntegrationWrapShapingStore](#integrationwrapshapingstore) [OnCacheOp](#observerfunc-oncacheop) |
...
| **Driver Configs** | [Shared BaseConfig](#driver-configs-shared-baseconfig) [Redis Config](#driver-config-rediscache) [Memcached Config](#driver-config-memcachedcache) [NATS Config](#driver-config-natscache) [DynamoDB Config](#driver-config-dynamocache) [SQLite Config](#driver-config-sqlitecache) [Postgres Config](#driver-config-postgrescache) [MySQL Config](#driver-config-mysqlcache) [SQL Core Config](#driver-config-sqlcore) |


_Examples assume `ctx := context.Background()` and `c := cache.NewCache(cache.NewMemoryStore(ctx))` unless shown otherwise._

### <a id="driver-configs"></a>Driver Config Examples (Optional Backends)
...
#### <a id="driver-config-rediscache"></a>Redis (`driver/rediscache`)
...
#### <a id="driver-config-memcachedcache"></a>Memcached (`driver/memcachedcache`)
...
#### <a id="driver-config-natscache"></a>NATS (`driver/natscache`)
...
#### <a id="driver-config-dynamocache"></a>DynamoDB (`driver/dynamocache`)
...
#### <a id="driver-config-sqlitecache"></a>SQLite (`driver/sqlitecache`)
...
#### <a id="driver-config-postgrescache"></a>Postgres (`driver/postgrescache`)
...
#### <a id="driver-config-mysqlcache"></a>MySQL (`driver/mysqlcache`)
...
#### <a id="driver-config-sqlcore"></a>SQL Core (`driver/sqlcore`, advanced/shared implementation)
...
### <a id="integrationwrapencryptingstore"></a>IntegrationWrapEncryptingStore
...
### <a id="integrationwrapshapingstore"></a>IntegrationWrapShapingStore
