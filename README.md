...
| **Invalidation** | [Delete](#delete) [DeleteCtx](#deletectx) [DeleteMany](#deletemany) [DeleteManyCtx](#deletemanyctx) [Flush](#flush) [FlushCtx](#flushctx) [Pull](#pull) [PullBytes](#pullbytes) [PullBytesCtx](#pullbytesctx) [PullCtx](#pullctx) |
| **Locking** | [Acquire](#acquire) [AcquireCtx](#acquirectx) [Block](#block) [BlockCtx](#blockctx) [Lock](#lock) [LockCtx](#lockctx) [NewLockHandle](#newlockhandle) [Release](#release) [ReleaseCtx](#releasectx) [TryLock](#trylock) [TryLockCtx](#trylockctx) [Unlock](#unlock) [UnlockCtx](#unlockctx) |
...
| **Rate Limiting** | [RateLimit](#ratelimit) [RateLimitCtx](#ratelimitctx) |
| **Read Through** | [Remember](#remember) [RememberBytes](#rememberbytes) [RememberBytesCtx](#rememberbytesctx) [RememberJSON](#rememberjson) [RememberJSONCtx](#rememberjsonctx) [RememberStale](#rememberstale) [RememberStaleBytes](#rememberstalebytes) [RememberStaleBytesCtx](#rememberstalebytesctx) [RememberStaleCtx](#rememberstalectx) [RememberStaleValueWithCodec](#rememberstalevaluewithcodec) [RememberString](#rememberstring) [RememberStringCtx](#rememberstringctx) [RememberValue](#remembervalue) [RememberValueWithCodec](#remembervaluewithcodec) |
| **Reads** | [BatchGetBytes](#batchgetbytes) [BatchGetBytesCtx](#batchgetbytesctx) [Get](#get) [GetBytes](#getbytes) [GetBytesCtx](#getbytesctx) [GetCtx](#getctx) [GetJSON](#getjson) [GetJSONCtx](#getjsonctx) [GetString](#getstring) [GetStringCtx](#getstringctx) |
| **Refresh Ahead** | [RefreshAhead](#refreshahead) [RefreshAheadBytes](#refreshaheadbytes) [RefreshAheadBytesCtx](#refreshaheadbytesctx) [RefreshAheadCtx](#refreshaheadctx) [RefreshAheadValueWithCodec](#refreshaheadvaluewithcodec) |
| **Writes** | [Add](#add) [AddCtx](#addctx) [BatchSetBytes](#batchsetbytes) [BatchSetBytesCtx](#batchsetbytesctx) [Decrement](#decrement) [DecrementCtx](#decrementctx) [Increment](#increment) [IncrementCtx](#incrementctx) [Set](#set) [SetBytes](#setbytes) [SetBytesCtx](#setbytesctx) [SetCtx](#setctx) [SetJSON](#setjson) [SetJSONCtx](#setjsonctx) [SetString](#setstring) [SetStringCtx](#setstringctx) |
...
### <a id="pullbytesctx"></a>PullBytesCtx
...
### <a id="newlockhandle"></a>NewLockHandle
...
### <a id="rememberbytesctx"></a>RememberBytesCtx
...
### <a id="batchgetbytes"></a>BatchGetBytes
...
### <a id="batchgetbytesctx"></a>BatchGetBytesCtx
...
_Example: acquire once and auto-release_
...
### <a id="getbytesctx"></a>GetBytesCtx
...
### <a id="refreshaheadbytes"></a>RefreshAheadBytes
...
### <a id="refreshaheadbytesctx"></a>RefreshAheadBytesCtx
...
### <a id="batchsetbytes"></a>BatchSetBytes
...
### <a id="batchsetbytesctx"></a>BatchSetBytesCtx
...
### <a id="setbytesctx"></a>SetBytesCtx
