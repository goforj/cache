...
| <img src="https://img.shields.io/badge/memcached-0198c4?logo=buffer&logoColor=white" alt="Memcached"> | Networked | ✓ | - | ✓ | ✓ |
...
| **Constructors** | [NewFileStore](#newfilestore) [NewMemcachedStore](#newmemcachedstore) [NewMemoryStore](#newmemorystore) [NewRedisStore](#newredisstore) [NewStore](#newstore) [NewStoreWith](#newstorewith) |
