...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/unit_tests-340-brightgreen" alt="Unit tests (executed count)">
...
| **Locking** | [Acquire](#acquire) [AcquireCtx](#acquirectx) [Block](#block) [BlockCtx](#blockctx) [Get](#get) [GetCtx](#getctx) [Lock](#lock) [LockCtx](#lockctx) [NewLockHandle](#newlockhandle) [Release](#release) [ReleaseCtx](#releasectx) [TryLock](#trylock) [TryLockCtx](#trylockctx) [Unlock](#unlock) [UnlockCtx](#unlockctx) |
...
| **Reads** | [BatchGet](#batchget) [BatchGetCtx](#batchgetctx) [GetJSON](#getjson) [GetJSONCtx](#getjsonctx) [GetString](#getstring) [GetStringCtx](#getstringctx) |
