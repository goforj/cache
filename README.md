...
<!-- test-count:embed:start -->
    <img src="https://img.shields.io/badge/tests-85-brightgreen" alt="Tests">
...
| Driver | Mode | Shared | Durable | TTL | Counters | Notes |
| ---: | :--- | :---: | :---: | :---: | :---: | :--- |
...
| **Constructors** | [NewFileStore](#newfilestore) [NewMemcachedStore](#newmemcachedstore) [NewMemoryStore](#newmemorystore) [NewNullStore](#newnullstore) [NewRedisStore](#newredisstore) [NewStore](#newstore) [NewStoreWith](#newstorewith) |
| **Memoization** | [NewMemoStore](#newmemostore) |
| **Other** | [WithDefaultTTL](#withdefaultttl) [WithFileDir](#withfiledir) [WithMemcachedAddresses](#withmemcachedaddresses) [WithMemoryCleanupInterval](#withmemorycleanupinterval) [WithPrefix](#withprefix) [WithRedisClient](#withredisclient) |
